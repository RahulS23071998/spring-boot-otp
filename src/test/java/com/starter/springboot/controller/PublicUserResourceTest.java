...
class PublicUserResourceTest {
    ...
    void setUp() {
        ...
        validUserRequest.setUsername("Diona.smith");
        validUserRequest.setPassword("SecurePass123");
        validUserRequest.setFirstName("Diona");
        validUserRequest.setLastName("Smith"); // Must be 4-50 characters
        validUserRequest.setEmail("Diona.smith@example.com");
        ...
        sampleUser = new User();
        sampleUser.setId(1L);
        sampleUser.setUsername("Diona.smith");
        sampleUser.setPassword("encoded-password");
        sampleUser.setFirstName("Diona");
        sampleUser.setLastName("Smith");
        sampleUser.setEmail("Diona.smith@example.com");
    ...
    void testCreateUserSuccessfully() throws Exception {
        ...
        mockMvc.perform(post("/api/users/public")
                ...
                .andExpect(jsonPath("$.firstName", is("Diona")))
                .andExpect(jsonPath("$.lastName", is("Smith")))
                .andExpect(jsonPath("$.email", is("Diona.smith@example.com")))
    ...
    void testUpdateUserStatusSuccessfully() throws Exception {
        ...
        updatedUser.setUsername("Diona.smith");
        updatedUser.setFirstName("Diona");
        updatedUser.setLastName("Smith");
        updatedUser.setEmail("Diona.smith@example.com");
    ...
    void testChangePasswordByUserIdSuccessfully() throws Exception {
        ...
        passwordPayload.put("currentPassword", "CurrentSecurePass123");
        passwordPayload.put("newPassword", "NewSecurePass456");
    ...
    void testChangePasswordByUsernameSuccessfully() throws Exception {
        // Arrange
        Map<String, String> passwordPayload = new HashMap<>();
        passwordPayload.put("username", "Diona.smith");
        passwordPayload.put("currentPassword", "CurrentSecurePass123");
        passwordPayload.put("newPassword", "NewSecurePass456");

        when(userService.changePasswordByUsername(eq("Diona.smith"), eq(passwordPayload))).thenReturn(sampleUser);
        ...
        verify(userService).changePasswordByUsername(eq("Diona.smith"), eq(passwordPayload));
    }
    ...
    void testRejectDuplicateUserCreation() throws Exception {
        ...
        when(userService.createUser(any(User.class)))
            .thenThrow(new EntityExistsException("User with username 'Diona.smith' already exists"));
    ...
    void testHandleBadCredentialsException() throws Exception {
        ...
        Map<String, String> passwordPayload = new HashMap<>();
        passwordPayload.put("userid", "1");
        passwordPayload.put("currentPassword", "WrongSecurePass789");
        passwordPayload.put("newPassword", "NewSecurePass456");
