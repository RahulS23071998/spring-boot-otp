...
import com.starter.springboot.service.impl.OtpGenerator;
import com.starter.springboot.service.impl.OtpProperties;
...
class OtpGeneratorTest {
    ...
    void shouldStoreHashedOtpInRedisWithCorrectKeyAndExpiry() {
        ...
        verify(valueOperations).set(redisKey, expectedHash, EXPIRY_MINUTES, TimeUnit.MINUTES);
        verify(valueOperations).set(redisKey + OtpConstants.STATUS_KEY_SUFFIX, OtpConstants.STATUS_ACTIVE, EXPIRY_MINUTES, TimeUnit.MINUTES);
        verify(valueOperations).set(redisKey + OtpConstants.FAILURE_KEY_SUFFIX, "0", EXPIRY_MINUTES, TimeUnit.MINUTES);
    }
